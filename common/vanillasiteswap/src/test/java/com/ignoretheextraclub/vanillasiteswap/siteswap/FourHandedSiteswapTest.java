...
public class FourHandedSiteswapTest
{
    ...
    {
        s975 = FourHandedSiteswap.create("975", SortingStrategy.NO_SORTING_STRATEGY);
    }

    @Test
    public void testIsMirrored() throws Exception, InvalidSiteswapException
    {
        Assert.assertEquals(true, FourHandedSiteswap.create(new int[]{9,7,5}, SortingStrategy.NO_SORTING_STRATEGY).isMirrored());
        Assert.assertEquals(true, FourHandedSiteswap.create(s975.getStates()).isMirrored());
        Assert.assertEquals(false, FourHandedSiteswap.create("97", SortingStrategy.NO_SORTING_STRATEGY).isMirrored());
    }

    @Test
    public void testLeaderStringSiteswap() throws Exception, InvalidSiteswapException
    {
        Assert.assertEquals("957", FourHandedSiteswap.create(new int[]{9,7,5}, SortingStrategy.NO_SORTING_STRATEGY).getLeaderStringSiteswap());
    ...
    {
        Assert.assertEquals("795", FourHandedSiteswap.create(new int[]{9,7,5}, SortingStrategy.NO_SORTING_STRATEGY).getFollowerStringSiteswap());
    ...
    {
        Assert.assertEquals("4.5p 2.5p 3.5p", FourHandedSiteswap.create(new int[]{9,7,5}, SortingStrategy.NO_SORTING_STRATEGY).getLeaderPrechac());
    ...
    {
        Assert.assertEquals("3.5p 4.5p 2.5p", FourHandedSiteswap.create(new int[]{9,7,5}, SortingStrategy.NO_SORTING_STRATEGY).getFollowerPrechac());
